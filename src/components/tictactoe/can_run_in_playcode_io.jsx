            ...
            <div className="container"> 
                ...
                { this.state.gameStarted && <>
                    ...
                    <table className='table table-striped table-bordered table-sm'>
                        ...
                        <tbody>
                            <tr>
                                <td><button disabled={this.state.board[0].disableCell} className="btn btn-success" name={this.state.board[0].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[0].value}</button></td>
                                <td><button disabled={this.state.board[1].disableCell} className="btn btn-success" name={this.state.board[1].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[1].value}</button></td>
                                <td><button disabled={this.state.board[2].disableCell} className="btn btn-success" name={this.state.board[2].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[2].value}</button></td>
                            </tr>
                            <tr>
                                <td><button disabled={this.state.board[3].disableCell} className="btn btn-success" name={this.state.board[3].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[3].value}</button></td>
                                <td><button disabled={this.state.board[4].disableCell} className="btn btn-success" name={this.state.board[4].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[4].value}</button></td>
                                <td><button disabled={this.state.board[5].disableCell} className="btn btn-success" name={this.state.board[5].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[5].value}</button></td>
                            </tr>
                            <tr>
                                <td><button disabled={this.state.board[6].disableCell} className="btn btn-success" name={this.state.board[6].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[6].value}</button></td>
                                <td><button disabled={this.state.board[7].disableCell} className="btn btn-success" name={this.state.board[7].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[7].value}</button></td>
                                <td><button disabled={this.state.board[8].disableCell} className="btn btn-success" name={this.state.board[8].id}  onClick={this.updateBoard}style={{"font-size": "60px", width: "80px"}}>{this.state.board[8].value}</button></td>
                            </tr>
                        </tbody>
                    </table>
                </>}    
